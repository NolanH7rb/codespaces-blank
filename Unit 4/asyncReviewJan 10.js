...
'NOTES'
// A list is a data type that can be used to group and collect other data types together in one variable.
// list can contain all data types, including variables and other lists

'CLOSED NOTES'

var internationalFood = ['Ramen', 'Chili Sauce', 'Soy Sauce', 'Old Bay', 'Taheen']

var produceFood = ['apples', 'bell peppers', 'mushrooms', 'tomatoes', 'lemons']

groceryShopping = [internationalFood, produceFood];
